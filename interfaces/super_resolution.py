...
class TextSR(base.TextBase):
            ...
            for j, data in (enumerate(train_loader)):
                ...
                if iters % cfg.VAL.valInterval == 0:
                    ...
                    if sum(current_acc_dict.values()) > best_acc:
                        ...
                        logging.info('=============')
                        logging.info('best psnr {:.4f}'.format(1*(psnr_dict['easy']*1619
    ...
    def eval(self, model_list, val_loader, image_crit, index, aster, aster_info, data_name=None):
        ...
        for i, data in (enumerate(val_loader)):
            ...
            # print("label_strs:", len(label_strs))
            label_strs_copy = label_strs
            ...
            self.tripple_display(images_lr, images_sr[0], images_hr, predict_result_lr, predict_result_sr[0], label_strs, index)
